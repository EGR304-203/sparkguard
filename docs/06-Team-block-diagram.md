...
In the same avenue, some of his calculations that would have provided the customer with power usage data had to be kept simple. The kilowatt hour calculation, the conversion to show current in amperes, and showing instantaneous power in watts had to be postponed for version two of the product since  we had to keep to the project deliverable deadlines.<br>
